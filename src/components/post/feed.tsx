  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="text-muted-foreground text-sm">Memuat feed...</p>
      </div>
    )
  }
        ...
        {posts.length === 0 ? (
          ...
          >
            <div className="bg-muted/50 rounded-lg p-8">
              <h3 className="font-semibold text-lg mb-2">Belum ada postingan</h3>
              <p className="text-muted-foreground text-sm">
                Jadilah yang pertama berbagi sesuatu!
              </p>
            </div>
          </motion.div>
        ) : (
