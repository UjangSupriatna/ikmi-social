...
function formatDateRange(start: Date, end: Date | null, current?: boolean): string {
  ...
  const startStr = startDate.toLocaleDateString('id-ID', { month: 'long', year: 'numeric' })
  ...
  if (end) {
    ...
    const endStr = endDate.toLocaleDateString('id-ID', { month: 'long', year: 'numeric' })
...
export function CVSection({
  ...
  return (
    <div className={cn('space-y-6', className)}>
      {/* CV Header for Print - Hidden on screen */}
      {userProfile && (
        <div className="hidden print:block mb-8 text-center border-b-2 border-gray-800 pb-6">
      ...
      <Card className="print:shadow-none print:border-gray-300">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          ...
          {isOwnProfile && (
            <Button size="sm" variant="outline" onClick={onAddEducation} className="gap-1 no-print">
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex gap-3">
                        <div className="p-2 rounded-lg bg-primary/10 print:bg-gray-100">
                          <GraduationCap className="size-5 text-primary print:text-gray-700" />
                        </div>
                        <div>
      ...
      <Card className="print:shadow-none print:border-gray-300">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          ...
          {isOwnProfile && (
            <Button size="sm" variant="outline" onClick={onAddExperience} className="gap-1 no-print">
              <Plus className="size-4" />
              Tambah
            </Button>
          )}
                ...
                {experiences.map((exp, index) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex gap-3">
                        <div className="p-2 rounded-lg bg-primary/10 print:bg-gray-100">
                          <Building2 className="size-5 text-primary print:text-gray-700" />
                        </div>
                        <div>
      ...
      <Card className="print:shadow-none print:border-gray-300">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          ...
          {isOwnProfile && (
            <Button size="sm" variant="outline" onClick={onAddAchievement} className="gap-1 no-print">
              <Plus className="size-4" />
              Tambah
            </Button>
          )}
                ...
                {achievements.map((achievement, index) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex gap-3">
                        <div className="p-2 rounded-lg bg-primary/10 print:bg-gray-100">
                          <Award className="size-5 text-primary print:text-gray-700" />
                        </div>
                        <div>
      ...
      <Card className="print:shadow-none print:border-gray-300">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          ...
          {isOwnProfile && (
            <Button size="sm" variant="outline" onClick={onAddPortfolio} className="gap-1 no-print">
              <Plus className="size-4" />
              Tambah
            </Button>
          )}
                    ...
                    >
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex gap-3 flex-1">
                          <div className="p-2 rounded-lg bg-primary/10 print:bg-gray-100">
                            <ExternalLink className="size-5 text-primary print:text-gray-700" />
                          </div>
                              ...
                              <div className="flex flex-wrap gap-1 mt-2">
                                {techs.map((tech) => (
                                  <Badge
                                    key={tech}
                                    variant="secondary"
                                    className="text-xs bg-primary/10 text-primary print:bg-gray-200 print:text-gray-700"
                                  >
                                    {tech}
                                  </Badge>
                                ))}
