...
const notificationColors: Record<NotificationType, string> = {
  ...
  friend_accepted: 'bg-primary',
  like: 'bg-red-500',
  comment: 'bg-purple-500',
  group_invite: 'bg-primary',
  group_join_request: 'bg-orange-500',
  group_join_approved: 'bg-primary',
  group_join_rejected: 'bg-red-400',
  mention: 'bg-cyan-500',
}
      ...
      >
        ...
        {notification.actor && (
          <Avatar className="size-10 flex-shrink-0">
            <AvatarImage src={getImageUrl(notification.actor.avatar) || undefined} alt={notification.actor.name} />
