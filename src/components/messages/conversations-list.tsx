        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground hidden sm:block">Chat dengan teman</p>
            </div>
          </div>
          <Button variant="ghost" size="icon" onClick={onStartNewChat} className="size-8 shrink-0">
                  ...
                  <div className="relative shrink-0">
                    {conv.participants.length === 1 ? (
                      <Avatar className="size-10 sm:size-12">
                        <AvatarImage src={getImageUrl(conv.participants[0].avatar) || undefined} />
                    ...
                    {conv.isOnline && (
                      <div className="absolute bottom-0 right-0 size-3 sm:size-3.5 bg-primary rounded-full border-2 border-background" />
                    )}
