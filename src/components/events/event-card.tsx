...
import { Calendar, MapPin, Users, Clock, Video, ExternalLink, Eye } from 'lucide-react'
...
const categoryColors: Record<string, string> = {
  seminar: 'bg-primary/15 text-primary dark:text-primary border-primary/20',
  workshop: 'bg-primary/15 text-primary dark:text-primary border-primary/20',
...
export function EventCard({ event, onSelect }: EventCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-28 sm:h-32 bg-gradient-to-br from-primary/20 to-primary/10">
        {getImageUrl(event.image) ? (
          ...
          <div className="flex items-center justify-center h-full">
            {/* Date Card Design */}
            <div className="flex flex-col items-center bg-card/80 backdrop-blur-sm rounded-lg shadow-sm border p-2 sm:p-3">
        ...
        <div className="absolute top-2 right-2 flex flex-col gap-1">
          ...
          {!event.isFree && (
            <Badge variant="secondary" className="text-[10px] sm:text-xs px-2 py-0.5 bg-primary/80 text-primary-foreground">
          ...
          <div className="absolute bottom-2 left-2">
            <Badge 
              ...
              className={cn(
                ...
                event.userAttendance === 'going' && "bg-primary text-primary-foreground",
                event.userAttendance === 'interested' && "bg-primary/70 text-primary-foreground",
        ...
        <div className="flex items-center justify-between pt-2.5 border-t">
          ...
          <div className="flex items-center gap-2 min-w-0 flex-1">
            <Avatar className="size-6 sm:size-7 shrink-0">
              <AvatarImage src={getImageUrl(event.createdBy.avatar) || undefined} />
