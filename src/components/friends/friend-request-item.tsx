      ...
      >
        <Card className={cn('opacity-0', className)}>
          <CardContent className="p-4">
            <p className="text-sm text-gray-500 text-center">Permintaan dihapus</p>
          </CardContent>
        </Card>
      </motion.div>
    )
        ...
        <CardContent className="p-3 sm:p-4">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <Link href={`/profile/${user.username}`} className="flex-shrink-0">
              <Avatar className="size-10 sm:size-12 border-2 border-primary/20 hover:border-primary/40 transition-colors">
              ...
              {type === 'incoming' ? (
                <>
                  <Button
                    variant="default"
                    size="sm"
                    className="bg-primary hover:bg-primary/90 text-primary-foreground h-8 sm:h-9 px-2 sm:px-3"
                  ...
                  >
                    ...
                    <span className="hidden sm:inline ml-1">Terima</span>
                  </Button>
                  <Button
                    variant="outline"
                    size="sm"
