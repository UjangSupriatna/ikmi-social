  ...
  const renderEmptyIncoming = () => (
    <Card className="border-dashed">
      <CardContent className="p-6 text-center">
        ...
        <h3 className="font-medium text-muted-foreground mb-1">Tidak ada permintaan tertunda</h3>
        <p className="text-sm text-muted-foreground/70">
          Ketika seseorang mengirim permintaan pertemanan, akan muncul di sini
        </p>
      </CardContent>
    </Card>
  )
  ...
  const renderEmptyOutgoing = () => (
    <Card className="border-dashed">
      <CardContent className="p-6 text-center">
        ...
        <h3 className="font-medium text-muted-foreground mb-1">Tidak ada permintaan terkirim</h3>
        <p className="text-sm text-muted-foreground/70">
          Permintaan pertemanan yang tertunda akan muncul di sini
        </p>
      </CardContent>
    </Card>
  )
      ...
      <div className="mb-4 sm:mb-6">
        <div className="flex items-center gap-2 mb-3 sm:mb-4">
          ...
          {!isLoading && incomingRequests.length > 0 && (
            <Badge className="bg-primary text-primary-foreground ml-1 sm:ml-2 text-xs">
      ...
      <div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-sm sm:text-base text-foreground">Permintaan Terkirim</span>
