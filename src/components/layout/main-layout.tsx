  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex flex-1">
        ...
        >
          <Sidebar user={user} currentView={currentView} onNavigate={onNavigate} unreadMessagesCount={unreadMessagesCount} unreadNotificationsCount={unreadNotificationsCount} />
        </aside>
      ...
      {/* Mobile Navigation */}
      <MobileNav user={user} currentView={currentView} onNavigate={onNavigate} unreadMessagesCount={unreadMessagesCount} unreadNotificationsCount={unreadNotificationsCount} />
    </div>
  )
}
